  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        <h1 className="text-5xl font-bold text-center text-gray-900 mb-4">Student Testimonials</h1>
        <p className="text-xl text-center text-gray-600 mb-12">
          Real stories from students who achieved their target scores
        </p>

        <div className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Video Testimonials</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Written Testimonials</h2>
