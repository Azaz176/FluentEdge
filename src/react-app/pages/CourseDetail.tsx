        ...
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="bg-blue-50 rounded-lg p-8 mb-16">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Score Improvement Results</h3>
              <p className="text-lg text-gray-700">{course.improvement}</p>
            </div>

            <div className="mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Student Testimonials</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-4 italic">"Excellent coaching! Improved my score significantly."</p>
                  <p className="font-semibold">- Student Review</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-4 italic">"Best investment for my test preparation. Highly recommended!"</p>
                  <p className="font-semibold">- Student Review</p>
                </div>
              </div>
            </div>
