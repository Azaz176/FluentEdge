  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <article>
          <span className="inline-block px-3 py-1 bg-blue-100 text-blue-600 text-sm font-semibold rounded mb-4">
            {post.category}
          </span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {relatedPosts.map((related) => (
              ...
              >
                ...
                <h4 className="text-xl font-bold text-gray-900 mt-2">{related.title}</h4>
              </Link>
            ))}
          </div>
        </div>
