    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Book a Free Demo Class</h1>
          <p className="text-xl text-gray-600 mb-6">
            Experience our teaching style and see how we can help you achieve your target score
          </p>
          <div className="bg-blue-50 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">What to Expect in Your Demo</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Preferred Exam *</label>
                <select
                  name="exam"
                  value={formData.exam}
                  onChange={handleChange}
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Time Preference</label>
                <select
                  name="timePreference"
          ...
          <div>
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Why Book a Demo?</h3>
